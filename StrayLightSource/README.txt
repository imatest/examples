...
This folder contains example images of a small, bright light source. The light source was collimated, with an angular diameter of 0.11 degrees. The camera was focused at infinity and operated in linear, single-exposure mode. The images were deliberately overexposed to reveal stray light (flare). The original 12-bit RAW image data were demosaiced and converted to 16-bit RGB format by applying a 4-bit left shift.
